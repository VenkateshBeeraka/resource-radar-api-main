...
public class EndPointConfig {
	...
	public static final String EMPLOYEE_SEARCH_BY_NAME = "/searchbyname";
	public static final String ID = "/{id}";

	public static final String EMAIL_ID = "/emailId";
	public static final String ALLOCATIONS_BY_EMPLOYEE = "employee";
	public static final String ALLOCATIONS_BY_PROJECT = "project";
	...
	public static final String REPORTINGMANGER = "/reportingmanagers";
	public static final String SUBORDINATES = "/{empid}/subordinates";
